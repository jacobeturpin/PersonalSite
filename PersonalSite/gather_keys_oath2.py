''' 
    Slightly modified script provided by the fitbit package for obtaining the proper
    keys for a registered app for the Authorization Grant Flow
'''
...
# This is an optional parameter than can be used to capture keys on a user-defined port
